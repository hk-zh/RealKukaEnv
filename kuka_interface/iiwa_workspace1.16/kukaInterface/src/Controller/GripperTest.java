...
public class GripperTest extends RoboticsAPIApplication {
	...
	public GripperTest(RoboticsAPIContext context) {
		super(context);
	}
	...
	public static void main (String args[]) {
		...
		GripperTest t = new GripperTest(RoboticsAPIContext.createFromResource(GripperTest.class, "RoboticsAPI.config.xml"));
		t.initialize();
		t.run();
		t.dispose();
	}
