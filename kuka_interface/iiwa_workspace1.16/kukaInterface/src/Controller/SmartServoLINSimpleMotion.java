...
public class SmartServoLINSimpleMotion extends RoboticsAPIApplication
{
    ...
    public SmartServoLINSimpleMotion(RoboticsAPIContext context) {
    	super(context);
    }
    @Override
    ...
    public static void main(String[] args)
    {
        ...
        SmartServoLINSimpleMotion app = new SmartServoLINSimpleMotion(RoboticsAPIContext.createFromResource(CheckJointVelocityControl.class, "RoboticsAPI.config.xml"));
        app.initialize();
        app.run();
    }
