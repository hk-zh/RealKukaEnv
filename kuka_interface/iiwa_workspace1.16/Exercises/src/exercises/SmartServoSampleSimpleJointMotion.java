...
import exercises.Task_01_TeachIn;
...
public class SmartServoSampleSimpleJointMotion extends RoboticsAPIApplication
{
    ...
    public SmartServoSampleSimpleJointMotion(RoboticsAPIContext context) {
		super(context);
	}
    ...
    public static void main(String[] args)
    {
        ...
        SmartServoSampleSimpleJointMotion app = new
                SmartServoSampleSimpleJointMotion(RoboticsAPIContext.createFromResource(SmartServoSampleSimpleJointMotion.class, "RoboticsAPI.config.xml"));
